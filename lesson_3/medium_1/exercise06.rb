...
#I'd choose 2, it returns the modified buffer, leaving the original
#unmutated. the first one mutates the buffer that is passed in and
#returns a buffer, which is bad practice.